    ...
    return (
        <>
                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-6 col-md-12 col-xs-12 mx-4">
                            <div className="contents">
                                <h2 className="head-title">Collabara <br /><small>Bridging Gaps Through Shared Expertise</small></h2>
                                <p>Find the best answer to your technical question, help others answer theirs. Collabara is a community-based space to find and contribute answers to technical challenges.</p>
                            </div>
            ...
            <footer className="text-center text-lg-start" Style="background-color: #4e63d7; position:absolute; bottom:0vh;width:100%;">
                ...
                <div className="text-center text-white p-3" Style="background-color: #dc3545;">
                    © 2024 Made With ❤ Collabara
